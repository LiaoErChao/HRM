...
namespace EFEntity
{
    ...
    public class human_file
    {
        ...
        public int vhuman_age { get; set; }//年龄
        ...
        public int bonus_amount { get; set; }//调动次数
        ...
        public string attachment_name { get; set; }//相片
        ...
        public DateTime check_time { get; set; }//档案登记时间
        public DateTime change_time { get; set; }//档案登记时间
