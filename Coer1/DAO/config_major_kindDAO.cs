...
namespace DAO
{
    public class config_major_kindDAO : Iconfig_major_kindDAO1
    {

        private readonly TescDbContext1 tescDbContext;
        public config_major_kindDAO(TescDbContext1 tescDbContext) {
        ...
        public List<config_major_kindModel1> Select()
        {
            ...
            foreach (config_major_kind item in list)
            {
                config_major_kindModel1 moedl = new config_major_kindModel1()
                {
                    mfk_id = item.mfk_id,
                    major_kind_id = item.major_kind_id,
                    major_kind_name = item.major_kind_name
