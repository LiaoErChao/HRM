...
namespace DAO
{
    public class config_file_second_kindDAO : Iconfig_file_second_kindDAO
    {
        ...
        public config_file_second_kindDAO(TescDbContext tescDbContext) {
            this.tescDbContext = tescDbContext;
        }

        //添加
        public async Task<int> ADD(config_file_second_kindModel cffskm)
        {
        ...
        //修改查询
        public async Task<config_file_second_kindModel> Up(int id)
        {
            config_file_second_kind cffsk = await tescDbContext.second.FindAsync(id);
            config_file_second_kindModel cffskm = new config_file_second_kindModel()
            {
                fsk_id=cffsk.fsk_id,
        ...
        //修改
        public async Task<int> Update(config_file_second_kindModel cffskm)
        {
            config_file_second_kind cfsk = new config_file_second_kind()
            {
                fsk_id=cffskm.fsk_id,
