...
namespace DAO
{
    public class config_major_kindDAO : Iconfig_major_kindDAO
    {

        private readonly TescDbContext tescDbContext;
        public config_major_kindDAO(TescDbContext tescDbContext) {
            this.tescDbContext = tescDbContext;
        }

        //添加
        public async Task<int> Add(config_major_kindModel cmm)
        {
        ...
        //查询
        public async Task<List<config_major_kindModel>> Load()
        {
            ...
            foreach (config_major_kind item in list)
            {
                ...
                config_major_kindModel cffkm = new config_major_kindModel()
                {
                   mfk_id=item.mfk_id,
